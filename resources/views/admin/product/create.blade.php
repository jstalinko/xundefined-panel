...
<form action="{{ route('product.store') }}" method="POST" id="productForm">
    ...
    <div class="cyber-panel">
        <div class="cyber-panel-header">
            ...
            <span class="badge-status b-ok">NEW ENTRY</span>
        </div>
            ...
            <div class="release-row-card" style="background: rgba(14, 11, 16, 0.7); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: var(--radius-sm); padding: 16px;">
                ...
                <div style="display: grid; grid-template-columns: 2fr 1fr 2fr; gap: 12px;" class="release-fields-grid">
                    <div>
                        ...
                        <input type="text" name="releases[0][file]" class="cyber-input" placeholder="e.g. package-v1.0.0.zip" value="package-v1.0.0.zip" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="releases[0][md5sum]" class="cyber-input" placeholder="e.g. a9f1b2c3d4e5f60718293a4b5c6d7e8f" value="{{ md5(uniqid()) }}">
                    </div>
                </div>
